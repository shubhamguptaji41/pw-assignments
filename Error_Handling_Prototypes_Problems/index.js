...
//02.Building Robust Functions in JavaScript//
...
function getPerson(person) {
  ...
  console.log(getPerson({ name: "Rajat", age: 24 })); 
  console.log(getPerson({ name: "Rajat" }));
  console.log(getPerson(["name", "Rajat"]));



//03.Car Description Class//
...
class Employee {
  ...
  const employee1 = new Employee("Rajat Kumar", "Software Engineer", 60000);
...
class Person {
  ...
  const person1 = new Person("Rajat", 24);
...
class Calculator {
  ...
  const result = Calculator.add(5, 15);
...
//09.Check the presence using closures//
